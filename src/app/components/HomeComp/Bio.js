...
export default function BioData(){
    ...
    return(
        <div id="Bio" className={` ml-[80px] max-[1233px]:mt-[30px] max-[861px]:ml-[30px] max-[348px]:ml-[20px] max-[393px]:mt-[0px] ${isVisible?styles.BioAnimate:styles.BionotAnimate}`}>
            ...
            <p id="para" className={`w-[80%] text-[#d4d3d3] mt-[20px] leading-relaxed max-[1139px]:text-[15px] max-[800px]:text-[17px] max-[477px]:text-[15px] max-[393px]:text-[13px] ${isPara?styles.paraAnim:styles.paranotAnim}`}>As a frontend developer, I craft engaging and responsive web experiences using HTML, CSS, and JavaScript. My expertise extends to building dynamic interfaces with React and Next.js, ensuring efficient and seamless user interactions.</p>
