            ...
            <div id="bar" className={`w-full select-none ${isVisible?styles.wholeAnim:styles.wholenotAnim}`}>
                ...
                <div className=" flex justify-center mt-[30px] ml-[40px] mr-[40px] max-[900px]:flex-col max-[900px]:items-center">
                    <div id="skill" className={`max-[1205px]:w-[45%] mr-[40px] max-[1003px]:mr-[0px] max-[900px]:w-[90%] `}>
                        ...
                        <TechnicalSkills  data={{ lang: "JavaScript", quant: "70%", width: "w-[380px]", reswid:"max-[1205px]:w-[70%]" ,anim:isVisible?styles.bar3ANim:styles.bar3NotAnim}} />
                        <TechnicalSkills  data={{ lang: "React.Js", quant: "60%", width: "w-[350px]", reswid:"max-[1205px]:w-[60%]" ,anim:isVisible?styles.bar4ANim:styles.bar4NotAnim}} />
                        <TechnicalSkills  data={{ lang: "Next.Js", quant: "60%", width: "w-[350px]", reswid:"max-[1205px]:w-[60%]",anim:isVisible?styles.bar5ANim:styles.bar5NotAnim}} />
                    </div>
